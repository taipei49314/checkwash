...
**Current adoption entry:** [v0.4.2 candidate and release record](releases/v0.4.2-public-launch.md). Use that dated brief instead of this archived draft. The test count in this archive is synchronized by the current packaging check; it is not a historical v0.1.25 test result.
