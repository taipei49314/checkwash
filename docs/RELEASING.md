...
fixed Action SHA under the one-release trust lag is a separate, later step;
the recommended pin stays v0.2.13 until then. The exact ledger-cleanup review
is still a separate governance change (D-055).
