...
One page for a security or platform team evaluating checkwash v0.3.2
...
local installation behavior. The recommended Action pin is v0.3.1 (advanced
by v0.3.2 under the one-release trust lag; the v0.3.0 engine) and carries
...
The README's Action is hash-pinned to **v0.3.1** under the one-release
trust-lag policy. Installing the v0.3.2 CLI does not update that Action;
