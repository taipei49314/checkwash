...
> Status: **pre-release.** 21 detectors, 470 tests, zero runtime dependencies.
...
- **Out of sample it does worse, and that is published too** — three projects never in the tuning
  corpus: 667 commits, 15 blocks, **11 false positives (1.65%)** against the 1.44% measured on the
...
```bash
pipx install git+https://github.com/taipei49314/greenwash@v0.1.45
# or: uv tool install git+https://github.com/taipei49314/greenwash@v0.1.45
  ...
  greenwash:
    ...
    steps:
      ...
      - uses: actions/setup-python@a26af69be951a213d495a4c3e4e4022e16d87065 # v5.6.0
        with:
          python-version: "3.12"
      - uses: taipei49314/greenwash/action@f97cdb4a6338144ae093a9d5476fbb6597f29718 # v0.1.44
```
...
- **Human-commit block rate — 41 / 1800 = 2.28%.** Six active OSS projects
  ...
  commit against the real diff: **26 false positives (1.44%)**, 15 legitimate
