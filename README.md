...
> Status: **pre-release.** 19 detectors, 331 tests, zero runtime dependencies.
...
```bash
pipx install git+https://github.com/taipei49314/greenwash@v0.1.18
# or: uv tool install git+https://github.com/taipei49314/greenwash@v0.1.18
...
jobs:
  greenwash:
    ...
    steps:
      ...
      - uses: taipei49314/greenwash/action@v0.1.18
```
...
- **A live miss in this repository, the day after that arm ran.** Another agent
  ...
  unchanged assertion. Closed in v0.1.18 by `ASSERT_SUBSTITUTED`, which is the
