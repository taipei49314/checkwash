...
> Status: **pre-release.** 21 detectors, 388 tests, zero runtime dependencies.
...
```bash
pipx install git+https://github.com/taipei49314/greenwash@v0.1.31
# or: uv tool install git+https://github.com/taipei49314/greenwash@v0.1.31
...
jobs:
  greenwash:
    ...
    steps:
      ...
      - uses: taipei49314/greenwash/action@v0.1.31
```
