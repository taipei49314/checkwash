...
> Status: **pre-release.** 20 detectors, 339 tests, zero runtime dependencies.
...
```bash
pipx install git+https://github.com/taipei49314/greenwash@v0.1.22
# or: uv tool install git+https://github.com/taipei49314/greenwash@v0.1.22
...
jobs:
  greenwash:
    ...
    steps:
      ...
      - uses: taipei49314/greenwash/action@v0.1.22
```
...
- **A live miss in this repository, the day after that arm ran.** Another agent
  ...
  unchanged assertion. Closed in v0.1.22 by `ASSERT_SUBSTITUTED`, which is the
