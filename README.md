...
```bash
pipx install git+https://github.com/taipei49314/checkwash@v0.2.10
# or: uv tool install git+https://github.com/taipei49314/checkwash@v0.2.10
  ...
  checkwash:
    ...
    steps:
      ...
      - uses: actions/setup-python@5fda3b95a4ea91299a34e894583c3862153e4b97 # v7.0.0
        with:
          python-version: "3.12"
      - uses: taipei49314/checkwash/action@760021d56b13af1332a5cb8eedd7ba20a9bfce47 # v0.2.9
```
...
`git rev-parse 'v0.2.9^{commit}'`; for another trusted release, substitute its
