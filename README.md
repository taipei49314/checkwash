...
> Status: **pre-release.** 21 detectors, 484 tests, zero runtime dependencies.
...
```bash
pipx install git+https://github.com/taipei49314/checkwash@v0.2.2
# or: uv tool install git+https://github.com/taipei49314/checkwash@v0.2.2
  ...
  checkwash:
    ...
    steps:
      ...
      - uses: actions/setup-python@a26af69be951a213d495a4c3e4e4022e16d87065 # v5.6.0
        with:
          python-version: "3.12"
      - uses: taipei49314/checkwash/action@65d7bbcbe6e6768d6084d4e03ee3aceccb4eddcd # v0.2.1
```
